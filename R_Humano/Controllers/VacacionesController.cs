...
namespace R_Humanos.Controllers
{
    public class VacacionesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,IdEmpleado,Desde,Hasta,Correspondiente_a,Comentarios")] Vacacione vacacione)
        {
            ...
            ViewBag.IdEmpleado = new SelectList(db.Empleados, "Id", "Nombre", vacacione.IdEmpleado);
            return View(vacacione);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,IdEmpleado,Desde,Hasta,Correspondiente_a,Comentarios")] Vacacione vacacione)
        {
            if (ModelState.IsValid)
            {
